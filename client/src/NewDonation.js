                                         ...
                                         <div class = "mb-4 mt-4 p-2 bg-qst">
                                            {Object.values(question).map((questionText) =>
                                             <div class = "mb-4 mt-4 p-2 bg-qst">
                                                ...
                                                <br></br>
                                                <label class="radio-inline fs-18 mt-2"><input type="radio" name={"optradio" + questionText.substr(0,1) }/>Yes</label>
                                                <label class="radio-inline fs-18 mt-2"><input type="radio" name={"optradio" + questionText.substr(0,1) }/>No</label>
                                                </div>
                                            )}
                                         </div>
                                    ))}
